...
class EmployeeStaffApi {
  ...
  getStaff({
    ...
    try {
      ...
      final String api = "${base}api/EmployeeLateInEarlyOutReportFacade/get_employee";
      ...
      logger.d(api);
        ...
        "multipledes": selectedDesignation.substring(0, selectedDesignation.length-0),
      ...
      final Response response =
        ...
        "ASMAY_Id": asmayId,
        "multipledep": departments.substring(0, departments.length-1),
        "multipledes": selectedDesignation.substring(0, selectedDesignation.length-1),
       "multipletype": "1,2,3,4,5,6,7"
