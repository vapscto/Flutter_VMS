class SalaryDeductionModel {
  String? type;
  List<SalaryDeductionModelValues>? values;

  SalaryDeductionModel({this.type, this.values});

  SalaryDeductionModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <SalaryDeductionModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(SalaryDeductionModelValues.fromJson(v));
      });
    }
  }
...
class SalaryDeductionModelValues {
  int? emeRId;
  int? intBId;
  int? roleid;
  ...
  SalaryDeductionModelValues.fromJson(Map<String, dynamic> json) {
    emeRId = json['emeR_Id'];
    intBId = json['intB_Id'];
    roleid = json['roleid'];
    ...
    hrmedAmount = json['hrmed_Amount']??0.0;
    hrmedName = json['hrmed_Name']?? 'n/a';
    id = json['id'];
    hreSId = json['hreS_Id'];
    hresId = json['hres_id'];
    userId = json['userId'];
