class TotalDeductionModel {
  String? type;
  List<TotalDeductionModelValues>? values;

  TotalDeductionModel({this.type, this.values});

  TotalDeductionModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <TotalDeductionModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(TotalDeductionModelValues.fromJson(v));
      });
    }
  }
...
class TotalDeductionModelValues {
  int? emeRId;
  int? intBId;
  int? roleid;
  ...
  TotalDeductionModelValues.fromJson(Map<String, dynamic> json) {
    emeRId = json['emeR_Id'];
    intBId = json['intB_Id'];
    roleid = json['roleid'];
