class TotalEarningModel {
  String? type;
  List<TotalEarningModelValues>? values;

  TotalEarningModel({this.type, this.values});

  TotalEarningModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <TotalEarningModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(TotalEarningModelValues.fromJson(v));
      });
    }
  }
...
class TotalEarningModelValues {
  ...
  TotalEarningModelValues.fromJson(Map<String, dynamic> json) {
    emeRId = json['emeR_Id'];
    intBId = json['intB_Id'];
    roleid = json['roleid'];
