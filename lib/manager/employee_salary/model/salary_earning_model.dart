class SalaryEarningModel {
  String? type;
  List<SalaryEarningModelValues>? values;

  SalaryEarningModel({this.type, this.values});

  SalaryEarningModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <SalaryEarningModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(SalaryEarningModelValues.fromJson(v));
      });
    }
  }
...
class SalaryEarningModelValues {
  int? emeRId;
  int? intBId;
  int? roleid;
  ...
  SalaryEarningModelValues.fromJson(Map<String, dynamic> json) {
    emeRId = json['emeR_Id'];
    intBId = json['intB_Id'];
    roleid = json['roleid'];
