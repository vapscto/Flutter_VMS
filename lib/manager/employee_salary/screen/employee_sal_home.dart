...
import 'package:m_skool_flutter/manager/employee_salary/api/employee_department_api.dart';
import 'package:m_skool_flutter/manager/employee_salary/api/employee_designation_api.dart';
import 'package:m_skool_flutter/manager/employee_salary/controller/employee_salary_controller.dart';
import 'package:m_skool_flutter/manager/employee_salary/widget/select_designation.dart';
...
class EmployeeSalHome extends StatefulWidget {
  final LoginSuccessModel loginSuccessModel;
  final MskoolController mskoolController;
  const EmployeeSalHome(
      {super.key,
      required this.loginSuccessModel,
      required this.mskoolController});

  @override
  State<EmployeeSalHome> createState() => _EmployeeSalHomeState();
}

class _EmployeeSalHomeState extends State<EmployeeSalHome> {
  final EmployeeSalaryController salaryController =
      Get.put(EmployeeSalaryController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(title: "Employee Salary Details").getAppBar(),
      body: Obx(() {
