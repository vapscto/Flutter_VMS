class FeeDetailsSelectedYear {
  String? type;
  List<FeeDetailsSelectedYearValues>? values;

  FeeDetailsSelectedYear({this.type, this.values});

  FeeDetailsSelectedYear.fromJson(Map<String, dynamic> json) {
    type = json['$type'];
    if (json['\$values'] != null) {
      values = <FeeDetailsSelectedYearValues>[];
      json['\$values'].forEach((v) {
        values!.add(FeeDetailsSelectedYearValues.fromJson(v));
      });
    }
  }
...
class FeeDetailsSelectedYearValues {
  int? asmaYId;
  int? mIId;
  String? asmaYYear;
  ...
  FeeDetailsSelectedYearValues.fromJson(Map<String, dynamic> json) {
