class GallerySectionModel {
  String? type;
  List<GallerySectionModelValues>? values;

  GallerySectionModel({this.type, this.values});

  GallerySectionModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <GallerySectionModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(new GallerySectionModelValues.fromJson(v));
      });
    }
  }
...
class GallerySectionModelValues {
  int? mIId;
  int? asmaYId;
  int? userId;
  bool? returnval;
  ...
  GallerySectionModelValues.fromJson(Map<String, dynamic> json) {
    mIId = json['mI_Id'];
