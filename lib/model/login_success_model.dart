...
class LoginSuccessModel {
  ...
  StaffAnalyticsPrivilages? staffAnalyticsPrivilages;
  String? cutoffdate;
  ...
  LoginSuccessModel.fromJson(Map<String, dynamic> json) {
    ...
    staffmobileappprivileges = json['staffmobileappprivileges'] != null
        ...
        : null;
    staffAnalyticsPrivilages = json['staffanalyticalprivileges'] == null
        ? null
        : StaffAnalyticsPrivilages.fromJson(json['staffanalyticalprivileges']);
  ...
  Map<String, dynamic> toJson() {
    ...
    if (staffAnalyticsPrivilages != null) {
      data['staffAnalyticsPrivilages'] = staffAnalyticsPrivilages!.toJson();
    }
