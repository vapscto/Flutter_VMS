class DailyTTClassesModel {
  String? type;
  List<DailyTTClassesModelValues>? values;

  DailyTTClassesModel({this.type, this.values});

  DailyTTClassesModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <DailyTTClassesModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(DailyTTClassesModelValues.fromJson(v));
      });
    }
  }
...
class DailyTTClassesModelValues {
  int? emeRId;
  int? intBId;
  int? roleid;
  ...
  DailyTTClassesModelValues.fromJson(Map<String, dynamic> json) {
    emeRId = json['emeR_Id'];
    intBId = json['intB_Id'];
    roleid = json['roleid'];
