...
class YearGetData {
  String? type;
  List<YearGetDataValues>? values;

  YearGetData({this.type, this.values});

  YearGetData.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <YearGetDataValues>[];
      json['\$values'].forEach((v) {
        values!.add(YearGetDataValues.fromJson(v));
      });
    }
  }
...
class YearGetDataValues {
  ...
  YearGetDataValues.fromJson(Map<String, dynamic> json) {
