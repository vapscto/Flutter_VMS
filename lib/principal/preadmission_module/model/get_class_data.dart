...
class ClassGetData {
  String? type;
  List<ClassGetDataValues>? values;

  ClassGetData({this.type, this.values});

  ClassGetData.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <ClassGetDataValues>[];
      json['\$values'].forEach((v) {
        values!.add(ClassGetDataValues.fromJson(v));
      });
    }
  }
...
class ClassGetDataValues {
  ...
  ClassGetDataValues.fromJson(Map<String, dynamic> json) {
