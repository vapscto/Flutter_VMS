class YearListModel {
  String? type;
  List<YearListModelValues>? values;

  YearListModel({this.type, this.values});

  YearListModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <YearListModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(new YearListModelValues.fromJson(v));
      });
    }
  }
...
class YearListModelValues {
  ...
  YearListModelValues.fromJson(Map<String, dynamic> json) {
