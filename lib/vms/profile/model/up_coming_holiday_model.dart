class UpComingHolidayModel {
  String? type;
  List<UpComingHolidayModelValues>? values;

  UpComingHolidayModel({this.type, this.values});

  UpComingHolidayModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <UpComingHolidayModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(UpComingHolidayModelValues.fromJson(v));
      });
    }
  }
...
class UpComingHolidayModelValues {
  dynamic userId;
  dynamic ismmaCId;
  dynamic mIId;
  dynamic ivrmmSId;
  ...
  UpComingHolidayModelValues(
      ...
      this.hrelSCBLeaves,
      this.fomhwdDName,
      this.fohtwDHolidayWDType,
      this.totalcount,
      this.fomhwdDFromDate,
      this.projectCount,
      this.taskCount,
      this.openCount,
      this.closedCount,
  ...
  UpComingHolidayModelValues.fromJson(Map<String, dynamic> json) {
    userId = json['userId'];
    ...
    fohtwDHolidayWDType = json['fohtwD_HolidayWDType'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['fohtwD_HolidayWDType'] = fohtwDHolidayWDType;
