class InstituteListModel {
  String? type;
  List<InstituteListModelValues>? values;

  InstituteListModel({this.type, this.values});

  InstituteListModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
...
class InstituteListModelValues {
  int? mIId;
  int? mOId;
  String? mIName;
  String? mICode;
  ...
  InstituteListModelValues.fromJson(Map<String, dynamic> json) {
    mIId = json['mI_Id'];
    mOId = json['mO_Id'];
    mIName = json['mI_Name'];
    mICode = json['mI_Code'];
