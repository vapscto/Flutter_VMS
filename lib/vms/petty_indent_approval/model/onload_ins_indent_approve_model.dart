class InstitutionIndentApprovalModel {
  String? type;
  List<InstitutionIndentApprovalModelValues>? values;

  InstitutionIndentApprovalModel({this.type, this.values});

  InstitutionIndentApprovalModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <InstitutionIndentApprovalModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(new InstitutionIndentApprovalModelValues.fromJson(v));
      });
    }
  }
...
class InstitutionIndentApprovalModelValues {
  int? mIId;
  int? mOId;
  String? mIName;
  String? mICode;
  ...
  InstitutionIndentApprovalModelValues.fromJson(Map<String, dynamic> json) {
    mIId = json['mI_Id'];
    mOId = json['mO_Id'];
    mIName = json['mI_Name'];
    mICode = json['mI_Code'];
