class InstitutionlistModel {
  String? type;
  List<InstitutionlistModelValues>? values;

  InstitutionlistModel({this.type, this.values});

  InstitutionlistModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <InstitutionlistModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(InstitutionlistModelValues.fromJson(v));
      });
    }
  }
...
class InstitutionlistModelValues {
  int? mIId;
  int? mOId;
  String? mIName;
  String? mICode;
  ...
  InstitutionlistModelValues.fromJson(Map<String, dynamic> json) {
    mIId = json['mI_Id'];
    mOId = json['mO_Id'];
    mIName = json['mI_Name'];
    mICode = json['mI_Code'];
