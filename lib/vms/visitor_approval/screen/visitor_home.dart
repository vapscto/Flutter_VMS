...
class VisitorApprovalHome extends StatefulWidget {
  const VisitorApprovalHome({super.key, 
...
class VisitorApprovalHomeState extends State<VisitorApprovalHome> {
  ...
  @override
  void initState() {
    VisitorApprovalApi.instance
        .getVisitorApprovalApi(base: "", userId: "60145", controller: controller, miId: '17');
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx( () => controller.getvisitorList.isEmpty
                                  ...
                                  cells: [
                                    DataCell(Align(
                                        ...
                                        child: Text('$i'))), 
                                         DataCell(Align(
                                        alignment: Alignment.center,
                                        child: Text( controller.getvisitorList.elementAt(index).mIName.toString()),
                                        )
                                        ),   
                                         DataCell(Align(
                                        alignment: Alignment.center,
                                        child: Text( controller.getvisitorList.elementAt(index).vMAPVisitorName.toString()),
                                        )
                                        ), 
                                         DataCell(Align(
                                        alignment: Alignment.center,
                                        child: Text( controller.getvisitorList.elementAt(index).hrmEEmployeeFirstName.toString()),
                                        )
                                        ), 
                                         DataCell(Align(
                                        alignment: Alignment.center,
                                        child: Text( controller.getvisitorList.elementAt(index).vMAPEntryDateTime.toString()),
                                        )
                                        ), 
                                          DataCell(Align(
                                        alignment: Alignment.center,
                                        child: Text( controller.getvisitorList.elementAt(index).createdby.toString()),
                                        )
                                        ),
                                          DataCell(Align(
                                        alignment: Alignment.center,
                                        child: Text( controller.getvisitorList.elementAt(index).vMAPStatus.toString()),
                                        )
                                        ), 
                                         DataCell(IconButton(
                                    onPressed: () {         
