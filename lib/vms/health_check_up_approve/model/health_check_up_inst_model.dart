class HealthCheckupInstModel {
  String? type;
  List<HealthCheckupInstModelValues>? values;

  HealthCheckupInstModel({this.type, this.values});

  HealthCheckupInstModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <HealthCheckupInstModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(HealthCheckupInstModelValues.fromJson(v));
      });
    }
  }
...
class HealthCheckupInstModelValues {
  int? mIId;
  int? mOId;
  String? mIName;
  String? mICode;
  ...
  String? mIGSTNO;
  String? mIWhatsAppName;
  String? mIWhatsApptype;
  String? mIWhatsAppToken;
  String? createdDate;
  String? updatedDate;

  HealthCheckupInstModelValues(
      {this.mIId,
      this.mOId,
      this.mIName,
      this.mICode,
      ...
      this.mIWhatsAppName,
      this.mIWhatsApptype,
      this.mIWhatsAppToken,
      this.createdDate,
      this.updatedDate});

  HealthCheckupInstModelValues.fromJson(Map<String, dynamic> json) {
    mIId = json['mI_Id'];
    mOId = json['mO_Id'];
    mIName = json['mI_Name'];
    mICode = json['mI_Code'];
    ...
    mIWhatsAppName = json['mI_WhatsAppName'];
    mIWhatsApptype = json['mI_WhatsApptype'];
    mIWhatsAppToken = json['mI_WhatsAppToken'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['mI_WhatsAppName'] = mIWhatsAppName;
    data['mI_WhatsApptype'] = mIWhatsApptype;
    data['mI_WhatsAppToken'] = mIWhatsAppToken;
