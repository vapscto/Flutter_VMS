class PurchaseItemDetailsModel {
  String? type;
  List<PurchaseItemDetailsModelValues>? values;

  PurchaseItemDetailsModel({this.type, this.values});
...
class PurchaseItemDetailsModelValues {
  bool? returnval;
  bool? alreadyCnt;
  int? mIId;
  int? mIIdNew;
  ...
  PurchaseItemDetailsModelValues(
      {this.returnval,
      this.alreadyCnt,
      this.mIId,
      this.mIIdNew,
  ...
  PurchaseItemDetailsModelValues.fromJson(Map<String, dynamic> json) {
