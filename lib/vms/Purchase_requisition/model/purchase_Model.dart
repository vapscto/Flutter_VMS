class PurchaseRequisitionModel {
  String? type;
  List<PurchaseRequisitionModelValues>? values;

  PurchaseRequisitionModel({this.type, this.values});

  PurchaseRequisitionModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <PurchaseRequisitionModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(PurchaseRequisitionModelValues.fromJson(v));
      });
    }
  }
...
class PurchaseRequisitionModelValues {
  int? mIId;
  int? mOId;
  String? mIName;
  String? mICode;
  ...
  PurchaseRequisitionModelValues.fromJson(Map<String, dynamic> json) {
    mIId = json['mI_Id'];
    mOId = json['mO_Id'];
    mIName = json['mI_Name'];
    mICode = json['mI_Code'];
