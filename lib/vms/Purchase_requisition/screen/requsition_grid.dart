...
class _RequisitionGridState extends State<RequisitionGrid> {
  ...
  onload() async {
    ...
    await getPurchaseRequisitionGridApi(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: SingleChildScrollView(
          child: Obx(() => controller.getrequestRequisitionGridList.isEmpty
                        ...
                        child: Column(children: [
                          ClipRRect(
                            ...
                            child: DataTable(
                              ...
                              rows: List.generate(
                                  controller.getrequestRequisitionGridList
                                      .length, (index) {
                                var i = index + 1;
                                return DataRow(
                                  cells: [
