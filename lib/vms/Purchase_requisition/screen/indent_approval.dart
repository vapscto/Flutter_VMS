...
class PurchaseApprovalDetails extends StatefulWidget {
 ...
 const PurchaseApprovalDetails(
  ...
  @override
  State<PurchaseApprovalDetails> createState() => _PurchaseApprovalDetailsState();
                      ...
                      child: Column(
                        ...
                        children: [
                          DataTable(
                              ...
                              rows: List.generate(
                                  controller.getpurchaseapprovaltapList.length,
                                  (index) {
                                var i = index + 1;
                                return DataRow(cells: [
                                  ...
                                  DataCell(Text(
                                   ...
                                   DataCell(Text(getDate(DateTime.parse( controller.getpurchaseapprovaltapList.elementAt(index).iNVMPIAPPPIDate!)))),
                                  DataCell(Text(
