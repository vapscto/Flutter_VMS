class CastListModel {
  String? type;
  List<CastListModelValues>? values;

  CastListModel({this.type, this.values});

  CastListModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <CastListModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(CastListModelValues.fromJson(v));
      });
    }
  }
...
class CastListModelValues {
  ...
  CastListModelValues.fromJson(Map<String, dynamic> json) {
    hrcDId = json['hrcD_Id'];
    mIId = json['mI_Id'];
    ...
    imCId = json['imC_Id'];
    imCCasteName = json['imC_CasteName'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['imC_Id'] = imCId;
    data['imC_CasteName'] = imCCasteName;
