class MaritalListModel {
  String? type;
  List<MaritalListModelValues>? values;

  MaritalListModel({this.type, this.values});

  MaritalListModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <MaritalListModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(MaritalListModelValues.fromJson(v));
      });
    }
  }
...
class MaritalListModelValues {
  ...
  MaritalListModelValues.fromJson(Map<String, dynamic> json) {
    hrcDId = json['hrcD_Id'];
    mIId = json['mI_Id'];
    ...
    ivrmmmSMaritalStatus = json['ivrmmmS_MaritalStatus'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['ivrmmmS_MaritalStatus'] = ivrmmmSMaritalStatus;
