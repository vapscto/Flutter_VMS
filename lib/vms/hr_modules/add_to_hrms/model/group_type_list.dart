class GroupTypeListModel {
  String? type;
  List<GroupTypeListModelValues>? values;

  GroupTypeListModel({this.type, this.values});

  GroupTypeListModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <GroupTypeListModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(GroupTypeListModelValues.fromJson(v));
      });
    }
  }
...
class GroupTypeListModelValues {
  dynamic hrcDId;
  dynamic mIId;
  dynamic hrmpTId;
  dynamic hrmCId;
  ...
  GroupTypeListModelValues.fromJson(Map<String, dynamic> json) {
    hrcDId = json['hrcD_Id'];
    mIId = json['mI_Id'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['hrmgT_EmployeeGroupType'] = hrmgTEmployeeGroupType;
