class ReligionListModel {
  String? type;
  List<ReligionListModelValues>? values;

  ReligionListModel({this.type, this.values});

  ReligionListModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <ReligionListModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(ReligionListModelValues.fromJson(v));
      });
    }
  }
...
class ReligionListModelValues {
  ...
  ReligionListModelValues.fromJson(Map<String, dynamic> json) {
    hrcDId = json['hrcD_Id'];
    mIId = json['mI_Id'];
    ...
    ivrmmRId = json['ivrmmR_Id'];
    ivrmmRName = json['ivrmmR_Name'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['ivrmmR_Id'] = ivrmmRId;
    data['ivrmmR_Name'] = ivrmmRName;
