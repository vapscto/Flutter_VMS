class AddToHrmsCandidateListModel {
  String? type;
  List<AddToHrmsCandidateListModelValues>? values;

  AddToHrmsCandidateListModel({this.type, this.values});

  AddToHrmsCandidateListModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <AddToHrmsCandidateListModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(AddToHrmsCandidateListModelValues.fromJson(v));
      });
    }
  }
...
class AddToHrmsCandidateListModelValues {
  dynamic hrcDId;
  dynamic mIId;
  dynamic hrmpTId;
  dynamic hrmCId;
  ...
  AddToHrmsCandidateListModelValues.fromJson(Map<String, dynamic> json) {
    hrcDId = json['hrcD_Id'];
    mIId = json['mI_Id'];
    ...
    hrcAId = json['hrcA_Id'];
    hrmPId = json['hrmP_Id'];
    hrcDFatherName = json['hrcD_FatherName'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['hrcA_Id'] = hrcAId;
    data['hrmP_Id'] = hrmPId;
    data['hrcD_FatherName'] = hrcDFatherName;
    return data;
  }
}
