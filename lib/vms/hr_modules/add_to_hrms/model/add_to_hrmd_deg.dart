class AddToHrmsDegModel {
  String? type;
  List<AddToHrmsDegModelValues>? values;

  AddToHrmsDegModel({this.type, this.values});

  AddToHrmsDegModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <AddToHrmsDegModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(AddToHrmsDegModelValues.fromJson(v));
      });
    }
  }
...
class AddToHrmsDegModelValues {
  ...
  AddToHrmsDegModelValues.fromJson(Map<String, dynamic> json) {
    hrcDId = json['hrcD_Id'];
    mIId = json['mI_Id'];
