class AddToHrmsEmpTypeModel {
  String? type;
  List<AddToHrmsEmpTypeModelValues>? values;

  AddToHrmsEmpTypeModel({this.type, this.values});

  AddToHrmsEmpTypeModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <AddToHrmsEmpTypeModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(AddToHrmsEmpTypeModelValues.fromJson(v));
      });
    }
  }
...
class AddToHrmsEmpTypeModelValues {
  dynamic hrcDId;
  dynamic mIId;
  dynamic hrmpTId;
  dynamic hrmCId;
  ...
  AddToHrmsEmpTypeModelValues.fromJson(Map<String, dynamic> json) {
    hrcDId = json['hrcD_Id'];
    mIId = json['mI_Id'];
    ...
    hrmeTEmployeeType = json['hrmeT_EmployeeType'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['hrmeT_EmployeeType'] = hrmeTEmployeeType;
