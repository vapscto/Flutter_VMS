class CompanyListModel {
  String? type;
  List<CompanyListModelValues>? values;

  CompanyListModel({this.type, this.values});

  CompanyListModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <CompanyListModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(CompanyListModelValues.fromJson(v));
      });
    }
  }
...
class CompanyListModelValues {
  ...
  dynamic mIFontSize;
  String? mILogo;
  dynamic mIActiveFlag;
  dynamic mIFranchiseFlag;
  ...
  CompanyListModelValues.fromJson(Map<String, dynamic> json) {
    mIId = json['mI_Id'];
    mOId = json['mO_Id'];
    mIName = json['mI_Name'];
    mICode = json['mI_Code'];
