class AddToHrmsDepListModel {
  String? type;
  List<AddToHrmsDepListModelValues>? values;

  AddToHrmsDepListModel({this.type, this.values});

  AddToHrmsDepListModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <AddToHrmsDepListModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(AddToHrmsDepListModelValues.fromJson(v));
      });
    }
  }
...
class AddToHrmsDepListModelValues {
  dynamic hrcDId;
  dynamic mIId;
  dynamic hrmpTId;
  dynamic hrmCId;
  ...
  AddToHrmsDepListModelValues.fromJson(Map<String, dynamic> json) {
    hrcDId = json['hrcD_Id'];
    mIId = json['mI_Id'];
