class JobGenderListModel {
  String? type;
  List<JobGenderListModelValues>? values;

  JobGenderListModel({this.type, this.values});

  JobGenderListModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <JobGenderListModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(JobGenderListModelValues.fromJson(v));
      });
    }
  }
...
class JobGenderListModelValues {
  dynamic hrmrfRId;
  dynamic mIId;
  dynamic hrmPId;
  dynamic hrmlOId;
  ...
  JobGenderListModelValues.fromJson(Map<String, dynamic> json) {
