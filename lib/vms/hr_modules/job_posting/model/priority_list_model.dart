class PriorityListModel {
  String? type;
  List<PriorityListModelValues>? values;

  PriorityListModel({this.type, this.values});

  PriorityListModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <PriorityListModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(PriorityListModelValues.fromJson(v));
      });
    }
  }
...
class PriorityListModelValues {
  ...
  PriorityListModelValues.fromJson(Map<String, dynamic> json) {
