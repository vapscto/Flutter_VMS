class JobDepartmentListModel {
  String? type;
  List<JobDepartmentListModelValues>? values;

  JobDepartmentListModel({this.type, this.values});

  JobDepartmentListModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <JobDepartmentListModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(JobDepartmentListModelValues.fromJson(v));
      });
    }
  }
...
class JobDepartmentListModelValues {
  dynamic hrmrfRId;
  dynamic mIId;
  dynamic hrmPId;
  dynamic hrmlOId;
  ...
  JobDepartmentListModelValues.fromJson(Map<String, dynamic> json) {
