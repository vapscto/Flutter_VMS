class PositionListModel {
  String? type;
  List<PositionListModelValues>? values;

  PositionListModel({this.type, this.values});

  PositionListModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <PositionListModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(PositionListModelValues.fromJson(v));
      });
    }
  }
...
class PositionListModelValues {
  ...
  PositionListModelValues.fromJson(Map<String, dynamic> json) {
    hrmrfRId = json['hrmrfR_Id'];
    mIId = json['mI_Id'];
    hrmPId = json['hrmP_Id'];
    hrmPDesc = json['hrmP_Desc'];
    hrmPSkills = json['hrmP_Skills'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['mI_Id'] = mIId;
    data['hrmP_Id'] = hrmPId;
    data['hrmP_Desc'] = hrmPDesc;
    data['hrmP_Skills'] = hrmPSkills;
