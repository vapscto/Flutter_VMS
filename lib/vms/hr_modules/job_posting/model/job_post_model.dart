class JobPostListModel {
  String? type;
  List<JobPostListModelValues>? values;

  JobPostListModel({this.type, this.values});

  JobPostListModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <JobPostListModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(JobPostListModelValues.fromJson(v));
      });
    }
  }
...
class JobPostListModelValues {
  ...
  JobPostListModelValues.fromJson(Map<String, dynamic> json) {
