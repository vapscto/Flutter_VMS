...
import 'package:m_skool_flutter/vms/staff_leave_approval/api/leave_list_api.dart';
...
import 'package:m_skool_flutter/vms/staff_leave_approval/widget/leave_approval_item.dart';
...
class ListLeaveHomeScreen extends StatefulWidget {
  final LoginSuccessModel loginSuccessModel;
  final MskoolController mskoolController;
  final String title;
  const ListLeaveHomeScreen(
      {super.key,
  ...
  @override
  State<ListLeaveHomeScreen> createState() => _ListLeaveHomeScreenState();
}

class _ListLeaveHomeScreenState extends State<ListLeaveHomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        return leaveApproveController.isLeaveLoading.value
            ? const AnimatedProgressWidget(
                title: "Loading All Leaves",
                desc: "We are in process to load all the leaves...",
                animationPath: "assets/json/default.json")
            : (leaveApproveController.leaveApprovesList.isEmpty)
                ? const Center(
                    ...
                    child: Column(
                      children: [
                                                                    ...
                                                                    return Column(
                                                                      ...
                                                                      children: const [
                                                                        AnimatedProgressWidget(
                                                                            title:
                                                                                "Approving All Leaves",
                                                                            desc:
                                                                                "We are in process to approve all the leaves...",
                                                                            animationPath:
                        ...
                        ListView.separated(
                          ...
                          itemBuilder: (_, index) {
                            return Obx(() {
                              return AppliedLeaveAprovalItem(
                                value: leaveApproveController.leaveApprovesList
                                    .elementAt(index),
                                selectAll: selectAll.value,
                                onSelect: (b) {
                                  if (b) {
                                    selected.add(leaveApproveController
                                        .leaveApprovesList
                                        .elementAt(index));
                                    return;
                                  }
                                  selected.remove(leaveApproveController
                                      .leaveApprovesList
                                      .elementAt(index));
                                },
                          ...
                          itemCount:
                              leaveApproveController.leaveApprovesList.length,
                        ),
                      ],
                    ),
                  );
