...
class _FinalViewPlanerState extends State<FinalViewPlaner> {
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => Scaffold(
        ...
        body: controller.lastLoading.isTrue
            ? const AnimatedProgressWidget(
                title: "Loading...",
                desc: "We're loading your data",
                animationPath: "assets/json/default.json")
            : controller.finalPalnerDetails.isEmpty &&
                    controller.fileList.isEmpty &&
                    controller.finalViewAdvance.isEmpty &&
                    controller.leadStatusList.isEmpty &&
                                ...
                                Row(
                                  ...
                                  children: [
                                    RichText(
                                      ...
                                      TextSpan(
                                          text: controller
                                              .finalPalnerDetails.first.mIName,
                                          style: Theme.of(context)
                                              .textTheme
                                              .titleMedium!
                                      ...
                                      TextSpan(
                                          ...
                                          style: Theme.of(context)
                                              ...
                                              .merge(TextStyle(
                                                  ...
                                                  color: Colors.blue[600]))),
                                      TextSpan(
                                          text: controller.finalPalnerDetails
                                              .first.iERPlanName!
                                              .toUpperCase(),
                                          style: Theme.of(context)
                                              .textTheme
                                    ...
                                    RichText(
                                      ...
                                      TextSpan(
                                          text: getDate(DateTime.parse(
                                              controller.finalPalnerDetails
                                                  .first.vTADAAAAppliedDate!)),
                                          style: Theme.of(context)
                                              .textTheme
                                              .titleMedium!
                                              .merge(const TextStyle(
                                ...
                                SizedBox(
                                  ...
                                  child: ClipRRect(
                                      ...
                                      child: DataTable(
                                        ...
                                        rows: List.generate(
                                            controller.finalViewAdvance.length,
                                            (index) {
                                          int num = index + 1;
                                          return DataRow(cells: [
                                            DataCell(Align(
                                ...
                                SizedBox(
                                  ...
                                  child: ClipRRect(
                                      ...
                                      child: DataTable(
                                        ...
                                        rows: List.generate(
                                            controller.leadStatusList.length,
                                            (index) {
                                          return DataRow(cells: [
                                            DataCell(Align(
                                              alignment: Alignment.centerLeft,
  ...
  savaData(int appoveRecject) async {
    Get.dialog(
    ...
    await saveFinalTadaApprovalApi(
        approvecnt: appoveRecject,
        base: baseUrlFromInsCode('issuemanager', widget.mskoolController),
        hrmeId: widget.finalTadaTourApproval.hRMEId!,
        level: widget.finalTadaTourApproval.sanctionLevelNo!,
        miID: widget.finalTadaTourApproval.mIId!,
        userId: widget.loginSuccessModel.userId!,
        vtadaaId: widget.finalTadaTourApproval.vTADAAId!,
        vtadaaRemark: controller.etRemarks.value.text,
        vtadaaTotalSancatinedAmount:
            int.parse(controller.etSnactionedAmount.value.text),
        context: context);
  }
