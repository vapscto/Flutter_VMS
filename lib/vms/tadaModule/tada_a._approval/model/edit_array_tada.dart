class EditArrayTADAData {
  String? type;
  List<EditArrayTADADataValues>? values;

  EditArrayTADAData({this.type, this.values});

  EditArrayTADAData.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
...
class EditArrayTADADataValues {
  ...
  EditArrayTADADataValues.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    mIId = json['MI_Id'];
    mIName = json['MI_Name'];
