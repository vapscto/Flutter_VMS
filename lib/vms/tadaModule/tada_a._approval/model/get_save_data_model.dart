class GetSaveDataModel {
  String? type;
  List<GetSaveDataModelValues>? values;

  GetSaveDataModel({this.type, this.values});

  GetSaveDataModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <GetSaveDataModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(GetSaveDataModelValues.fromJson(v));
      });
    }
  }
...
class GetSaveDataModelValues {
  ...
  GetSaveDataModelValues.fromJson(Map<String, dynamic> json) {
