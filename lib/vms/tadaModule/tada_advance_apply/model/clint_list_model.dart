class ClintListModel {
  String? type;
  List<ClintListModelValues>? values;

  ClintListModel({this.type, this.values});

  ClintListModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <ClintListModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(ClintListModelValues.fromJson(v));
      });
    }
  }
...
class ClintListModelValues {
  ...
  ClintListModelValues.fromJson(Map<String, dynamic> json) {
