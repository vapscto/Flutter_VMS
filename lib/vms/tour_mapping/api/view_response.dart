...
Future<void> featchViewDemoRespose(
 ...
 try {
   ...
   logger.e(response) ;
   ViewLeadDemo viewDemoDetails = ViewLeadDemo.fromJson(response.data['view_lead_demo']);
   controller.viewDemoResopnseList.addAll(viewDemoDetails.values!);
   ViewLeadDemoProductResponse viewDemoProductResponse = ViewLeadDemoProductResponse.fromJson(response.data['product_dd_s']);
   controller.viewDemoPRoductList.addAll(viewDemoProductResponse.values!);
   DemoResponseDetails viewDemResponseDetails = DemoResponseDetails.fromJson(response.data['demo_response_details']);
   controller.viewDemoResponseDetailsList.addAll(viewDemResponseDetails.values!);
  } on DioError catch (e) {
    logger.e(e.message);
