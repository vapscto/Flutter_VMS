...
class _DemoResponsePageState extends State<DemoResponsePage> {
  ...
  final GetEmpDetailsController gpsController = Get.put(GetEmpDetailsController());
              ...
              child: ClipRRect(
                  ...
                  child: DataTable(
                    ...
                    columns:  widget.category =="Closure" ? [
                      ...
                      Align(
                        ...
                        Checkbox(
                          ...
                          value:checkAll.value , onChanged:  (value) {
                          checkAll.value =value!;
                          if(checkAll.value){
                            for(int i= 0;i<widget.controller.checkBoxList.length;i++){
                              widget.controller.checkBoxList[i]=true;
                              widget.controller.cheackedCheckBox.add(i);
                            }
                          }else{
                            for(int i= 0;i<widget.controller.checkBoxList.length;i++){
                              widget.controller.checkBoxList[i]=false;
                               widget.controller.cheackedCheckBox.clear();
                            }
                          }
                   ...
                   const   DataColumn(
                    ...
                    rows:
                      widget.category =="Closure" ?
                     List.generate(
                        widget.controller.listDemoRespose.length, (index) {
                      var num = index + 1;
                      return DataRow(cells: [
                        DataCell(
                          Align(child: Checkbox(value: widget.controller.checkBoxList[index],
                           onChanged: (value) {
                           widget.controller.checkBoxList[index]= value!; 
                            if( widget.controller.cheackedCheckBox.contains(index)){
                              widget.controller.cheackedCheckBox.remove(index);
                             }else{
                                widget.controller.cheackedCheckBox.add(index);
                             }
                             if( widget.controller.cheackedCheckBox.length==widget.controller.checkBoxList.length){
                              checkAll.value= true;
                            }else{
                      ...
                      return DataRow(cells: [
                        ...
                        DataCell(Align(
                          child: widget.controller.demoCancelList[index]  
                              ...
                              : Checkbox(
                                  checkColor: Colors.indigo[800],
                                  value: widget.controller.demoQutionFlag
                                      .elementAt(index),
                                  onChanged: (value) {
                                    widget.controller.demoQutionFlag[index] =
                                        value!;
                                  },
                                ),
                        )),
                 ...
                 const SizedBox(
                  ...
                  Row(
                    ...
                    children: [
                    MSkollBtn(title: "Save", onPress: ()async {
                      detailsList.clear();
                      saveDataList.clear();
                    for(int i =0;i<widget.controller.cheackedCheckBox.length;i++){
                        detailsList.add(
                          {
                            "ISMSLEDM_Id":widget.controller.listDemoRespose.elementAt(widget.controller.cheackedCheckBox[i]).ismsledMId,
                            "ISMSLEDMPR_Id": widget.iSMSLEId,
                            "ISMSMST_Id": widget.controller.demoDropDown.elementAt(widget.controller.cheackedCheckBox[i]),
                            "ISMSLEDMPR_Remarks": widget.controller.demoRemarkEdt.elementAt(widget.controller.cheackedCheckBox[i]).text,
                            "ISMSLECOM_SendQuotationFlg": widget.controller.demoQutionFlag.elementAt(widget.controller.cheackedCheckBox[i])== true ?1:0,
                            "ISMSLECOM_MoMFlg":widget.controller.demoMouList.elementAt(widget.controller.cheackedCheckBox[i])== true ? 1:0,
                            "ISMSLECOM_NonFlg": widget.controller.demoNegotiateList.elementAt(widget.controller.cheackedCheckBox[i])==true? 1:0,
                            "NON_Amount":widget.controller.demoNegotiateList.elementAt(widget.controller.cheackedCheckBox[i])==true? 
                            widget.controller.demoNegotiate.elementAt(widget.controller.cheackedCheckBox[i]).text:"",
                            "ISMSLECOM_CancelFlg": widget.controller.demoCancelList.elementAt(widget.controller.cheackedCheckBox[i])== true ?1:0,
