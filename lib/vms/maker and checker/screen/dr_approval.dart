...
class _DRApprovalScreenState extends State<DRApprovalScreen> {
 ...
 loadListDr() {
    ...
    for (int i = 0; i < controller.etRemakeList.length; i++) {
      getAllDrLists.add({
        "Approvedflag":    controller.statusET[i].text=="Approved" ?true : false,
    ...
    countToatalEffort += double.parse( controller.etHoursList[i].text.toString());
    }
                                ...
                                cells: [
                                  ...
                                  DataCell(Align(
                                    ...
                                    child: DropdownMenu<String>(
                                      ...
                                      controller:
                                          controller.statusET.elementAt(index),
                                      initialSelection: controller.sList.first,
