class OthersDayPlannedModel {
  String? type;
  List<OthersDayPlannedModelValues>? values;

  OthersDayPlannedModel({this.type, this.values});

  OthersDayPlannedModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <OthersDayPlannedModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(OthersDayPlannedModelValues.fromJson(v));
      });
    }
  }
...
class OthersDayPlannedModelValues {
  int? ismtpLId;
  int? mIId;
  int? hrmEId;
  int? ismtpLPlannedBy;
  ...
  OthersDayPlannedModelValues.fromJson(Map<String, dynamic> json) {
