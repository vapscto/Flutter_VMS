            ...
            SingleChildScrollView(
                ...
                child: ClipRRect(
                    ...
                    child: DataTable(
                      ...
                      rows:  List.generate(controller.getTourViewList.length, (index) {
                        int num  = index + 1;
                        return DataRow(cells:[
                          DataCell(Align(child: Text(
                          "$num"),)),
                          DataCell(
                            Align(child: Text(controller.getTourViewList.elementAt(index).mIName!,
                          ...
                          DataCell(
                            Align(child: Text(controller.getTourViewList.elementAt(index).empName!,
                            style: Theme.of(context).textTheme.titleSmall!.merge(
                              const TextStyle(
                              fontSize: 14,
                              fontWeight: FontWeight.w500,
                          ...
                          DataCell(
                            Align(child: 
                            Text(  controller.planerName.elementAt(index).locationName! ,
                            style: Theme.of(context).textTheme.titleSmall!.merge(
                              const TextStyle(
                              fontSize: 14,
                              fontWeight: FontWeight.w500,
