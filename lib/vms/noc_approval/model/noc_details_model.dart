class NocDetailsModel {
  String? type;
  List<NocDetailsModelValues>? values;

  NocDetailsModel({this.type, this.values});

  NocDetailsModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <NocDetailsModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(NocDetailsModelValues.fromJson(v));
      });
    }
  }
...
class NocDetailsModelValues {
  ...
  NocDetailsModelValues.fromJson(Map<String, dynamic> json) {
    type = json['$type'];
