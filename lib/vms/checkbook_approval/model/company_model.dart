class CompanyList {
  String? type;
  List<CompanyListValues>? values;

  CompanyList({this.type, this.values});

  CompanyList.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <CompanyListValues>[];
      json['\$values'].forEach((v) {
        values!.add(  CompanyListValues.fromJson(v));
      });
    }
  }
...
class CompanyListValues {
  ...
  CompanyListValues.fromJson(Map<String, dynamic> json) {
    mIId = json['mI_Id'];
    mOId = json['mO_Id'];
    mIName = json['mI_Name'];
    mICode = json['mI_Code'];
