class InterviewModelList {
  String? type;
  List<InterviewModelListValues>? values;

  InterviewModelList({this.type, this.values});

  InterviewModelList.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <InterviewModelListValues>[];
      json['\$values'].forEach((v) {
        values!.add(InterviewModelListValues.fromJson(v));
      });
    }
  }
...
class InterviewModelListValues {
  int? hrcisCId;
  int? hrcDId;
  int? mIId;
  ...
  InterviewModelListValues.fromJson(Map<String, dynamic> json) {
