class EmplyeeEnhancementModel {
  String? type;
  List<EmplyeeEnhancementModelValues>? values;

  EmplyeeEnhancementModel({this.type, this.values});

  EmplyeeEnhancementModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <EmplyeeEnhancementModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(EmplyeeEnhancementModelValues.fromJson(v));
      });
    }
  }
...
class EmplyeeEnhancementModelValues {
  bool? returnval;
  bool? roleflag;
  bool? completed;
  bool? pending;
  ...
  EmplyeeEnhancementModelValues.fromJson(Map<String, dynamic> json) {
