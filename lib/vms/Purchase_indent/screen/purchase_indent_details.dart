               ...
               children: [
                 ...
                 RichText(
                  ...
                  style: Get.textTheme.titleSmall!.copyWith(
                     ...
                     TextSpan(
                   text: controller.purchaseIndentList.first.mIName,
                 ...
                 RichText(
                  ...
                  style: Get.textTheme.titleSmall!.copyWith(
                      ...
                      color: Theme.of(context).primaryColor)),
                     TextSpan(
                  text: controller.purchaseIndentList.first.iNVMPIPINo,
                  style: Get.textTheme.titleSmall!
                 ...
                 RichText(
                  ...
                  style: Get.textTheme.titleSmall!.copyWith(
                      ...
                      color: Theme.of(context).primaryColor)),
                     TextSpan(
                  text: controller.purchaseIndentList.first.iNVMPIReferenceNo,
                  style: Get.textTheme.titleSmall!
                      .copyWith(fontWeight: FontWeight.w400)),
                   ]),
                 ),
                 ...
                 RichText(
                  ...
                  style: Get.textTheme.titleSmall!.copyWith(
                      ...
                      color: Theme.of(context).primaryColor)),
                     TextSpan(
                  text: controller.purchaseIndentList.first.iNVMPIApproxTotAmount.toString(),
                  style: Get.textTheme.titleSmall!
                      .copyWith(fontWeight: FontWeight.w400)),
                   ]),
                 ),
                 ...
                 RichText(
                  ...
                  style: Get.textTheme.titleSmall!.copyWith(
                      ...
                      color: Theme.of(context).primaryColor)),
                     TextSpan(
                  text: controller.purchaseIndentList.first.iNVMPIPIDate,
                  style: Get.textTheme.titleSmall!
                      .copyWith(fontWeight: FontWeight.w400)),
                   ]),
                 ),
                 ...
                 RichText(
                  ...
                  style: Get.textTheme.titleSmall!.copyWith(
                      ...
                      color: Theme.of(context).primaryColor)),
                     TextSpan(
                  text: controller.purchaseIndentList.first.indentCreadBy,
                  style: Get.textTheme.titleSmall!
                      .copyWith(fontWeight: FontWeight.w400)),
                   ]),
                 ),
                 ...
                 RichText(
                  ...
                  style: Get.textTheme.titleSmall!.copyWith(
                      ...
                      color: Theme.of(context).primaryColor)),
                     TextSpan(
                  text: controller.purchaseIndentList.first.iNVMPIRemarks,
                  style: Get.textTheme.titleSmall!
                      .copyWith(fontWeight: FontWeight.w400)),
                   ]),
                 ),
               ...
               child: SingleChildScrollView(
                ...
                return DataRow(
                  cells: [
                   ...
                   groupValue: controller.selectedValue[index],
                   value: 'Approved',
                   onChanged: (dynamic value) {
                    setState(() {
                      controller.selectedValue[index] = value;
                                 });
                                 },
                                )),
                                  DataCell(Radio(
                    ...
                    setState(() {
                     controller.selectedValue[index] = value;
                        ...
                        child: Text( controller.getOnclickList.elementAt(index).iNVTPIAPPApprovedQty.toString()),
                         ...
                         DataCell(TextField( controller: controller.unitControllerList.elementAt(index),keyboardType: TextInputType.number,)
                        ), 
                         DataCell(Align(
                        alignment: Alignment.center,
                        child: Text( controller.getOnclickList.elementAt(index).iNVTPIApproxAmount.toString()),
                         ...
                         DataCell(Align(
                        alignment: Alignment.center,
                        child: TextField( controller: controller.remarkControllerList.elementAt(index)),
                        )
                        ), 
                         DataCell( IconButton(
                          onPressed: () {
