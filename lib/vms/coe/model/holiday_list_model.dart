class HolidayListModel {
  String? type;
  List<HolidayListModelValues>? values;

  HolidayListModel({this.type, this.values});

  HolidayListModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <HolidayListModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(HolidayListModelValues.fromJson(v));
      });
    }
  }
...
class HolidayListModelValues {
  ...
  HolidayListModelValues.fromJson(Map<String, dynamic> json) {
    userId = json['userId'];
