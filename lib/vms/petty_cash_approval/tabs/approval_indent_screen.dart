...
class PcCashApprovalScreen extends StatefulWidget {
  final LoginSuccessModel loginSuccessModel;
  final MskoolController mskoolController;
  const PcCashApprovalScreen({
    super.key,
  ...
  @override
  State<PcCashApprovalScreen> createState() => _PcCashApprovalScreenState();
}

class _PcCashApprovalScreenState extends State<PcCashApprovalScreen> {
  ...
  _loadData() async {
    await getPcIndentApproval(
        ...
        fromDate: getDateNeed(_pcapprovalController.fromSelectedDate.value),
        toDate: getDateNeed(_pcapprovalController.toSelectedDate.value),
  ...
  void initState() {
    super.initState();
    loadData();
    selectDate.text = getDateNeed(_pcapprovalController.fromSelectedDate.value);
    selectEndDate.text = getEndDate(_pcapprovalController.toSelectedDate.value);
    fromDate.text = getDate(_pcapprovalController.fromSelectedDate.value);
    toDate.text = getDate(_pcapprovalController.toSelectedDate.value);
    _loadData();
  ...
  PCApprovalOnloadModelValues? selectedValue;
  @override
  Widget build(BuildContext context) {
    return Obx(() {
      return (isLoadingData.value == true)
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: DropdownButtonFormField<PCApprovalOnloadModelValues>(
                      ...
                      items: List.generate(
                        ...
                        return DropdownMenuItem(
                          value: _pcapprovalController.organizationList[index],
                          child: Padding(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (changes.value > 1) {
                                      if (_pcapprovalController
                                        ...
                                        _pcapprovalController.pcIndentDetails
                                            .clear();
                                      }
                  ...
                  _pcapprovalController.pcIndentDetails.isNotEmpty
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: DropdownButtonFormField<
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintStyle: Theme.of(context)
                                      ...
                                      .merge(const TextStyle(
                                          ...
                                          fontSize: 14.0,
                                          letterSpacing: 0.3)),
                                  hintText: _pcapprovalController
                                          .pcIndentDetails.isNotEmpty
                                      ? 'Select Indent No.'
                                      : 'No data available',
                                  floatingLabelBehavior:
                                ...
                                items: List.generate(
                                    _pcapprovalController
                                        .pcIndentDetails.length, (index) {
                                  return DropdownMenuItem(
                                    value: _pcapprovalController
                                        .pcIndentDetails[index],
                                    child: Padding(
                            ...
                            _pcapprovalController
                                                          ...
                                                          DataCell(
                                                            Align(
                                                                ...
                                                                child:
                                                                  ...
                                                                  child:
                                                                      AbsorbPointer(
                                                                    absorbing: !_pcapprovalController
                                                                        .checkList
                                                                        .elementAt(
                                                                            index),
                                                                    child:
                                ...
                                : Visibility(
                                    ...
                                    child: const AnimatedProgressWidget(
                                      ...
                                      desc:
                                          "Select the Indent No. to show the Data",
                                      animatorHeight: 250,
                                    ),
                                  ),
                          ],
                      ...
                      : Visibility(
                          ...
                          child: const AnimatedProgressWidget(
                            ...
                            desc:
                                "Select the From and To Date to show the Data",
                            animatorHeight: 250,
                          ),
                        ),
                ],
