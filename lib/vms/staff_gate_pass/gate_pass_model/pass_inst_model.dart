class GatePassInstModel {
  String? type;
  List<GatePassInstModelValues>? values;

  GatePassInstModel({this.type, this.values});

  GatePassInstModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <GatePassInstModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(GatePassInstModelValues.fromJson(v));
      });
    }
  }
...
class GatePassInstModelValues {
  ...
  GatePassInstModelValues.fromJson(Map<String, dynamic> json) {
    mIId = json['mI_Id'];
    mOId = json['mO_Id'];
    mIName = json['mI_Name'];
    mICode = json['mI_Code'];
