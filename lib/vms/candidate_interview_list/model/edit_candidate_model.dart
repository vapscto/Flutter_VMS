class DataChangeCandidateModel {
  String? type;
  List<DataChangeCandidateModelValues>? values;

  DataChangeCandidateModel({this.type, this.values});

  DataChangeCandidateModel.fromJson(Map<String, dynamic> json) {
    type = json['\$type'];
    if (json['\$values'] != null) {
      values = <DataChangeCandidateModelValues>[];
      json['\$values'].forEach((v) {
        values!.add(DataChangeCandidateModelValues.fromJson(v));
      });
    }
  }
...
class DataChangeCandidateModelValues {
  int? hrcisCId;
  int? hrcDId;
  int? mIId;
  ...
  DataChangeCandidateModelValues(
      {this.hrcisCId,
      this.hrcDId,
      this.mIId,
  ...
  DataChangeCandidateModelValues.fromJson(Map<String, dynamic> json) {
